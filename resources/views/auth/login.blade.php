                    ...
                    <div class="frame-4">
                            ...
                            <div class="text-field">
                                <div class="state-layer-wrapper">
                                    <div class="state-layer">
                                        <div class="content">
                                            <input class="input-text" type="email" name="email" value="{{ old('email') }}" required autofocus placeholder="john.doe@gmail.com"/>
                            ...
                            <div class="text-field">
                                <div class="div-wrapper">
                                    <div class="state-layer-2">
                                        <div class="content">
                                            <input class="input-text" type="password" name="password" required placeholder="•••••••••••••••••••••••••"/>
                                            <label class="label">Password</label>
                                        </div>
                                        <div class="trailing-icon"><img class="img" src="{{ asset('img/eye-off.svg') }}" /></div>
                                    </div>
                                </div>
                        ...
                        <div class="frame-8">
                            <button type="submit" class="button">
                                <div class="style-layer"><div class="button-2">Login</div></div>
                            </button>
